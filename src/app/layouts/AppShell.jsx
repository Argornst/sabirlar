...
const navigationItems = [
  ...
  },
  {
    ...
    {
    label: "Paketleme Hesaplayıcı",
    description: "Lot bazlı palet, ambalaj ve istif hesapları",
    path: "/logistics/packaging-calculator",
    pageKey: PAGE_KEYS.PRODUCTS,
    icon: BoxIcon,
    keywords: ["paketleme", "lojistik", "palet", "varil", "kutu"],
  },
  {
    label: "Paketleme Malzemeleri",
    description: "Palet, kutu, vakum torbası ve varil tiplerini yönet",
    path: "/logistics/packaging-materials",
    pageKey: PAGE_KEYS.PRODUCTS,
    icon: BoxIcon,
    keywords: ["malzeme", "paketleme", "kutu", "varil", "palet"],
  },
  {
    label: "Paketleme Geçmişi",
    description: "Kaydedilen paketleme hesaplamalarını görüntüle",
    path: "/logistics/packaging-history",
    pageKey: PAGE_KEYS.REPORTS,
    icon: ChartIcon,
    keywords: ["paketleme", "geçmiş", "history", "hesaplama"],
  },
    {
    label: "Ürün Ambalaj Kuralları",
    description: "Ürün bazlı izinli palet, kutu, varil ve torba eşleşmelerini yönet",
    path: "/logistics/packaging-rules",
    pageKey: PAGE_KEYS.PRODUCTS,
    icon: BoxIcon,
    keywords: ["paketleme", "kural", "ambalaj", "ürün", "varil", "palet"],
  },
  {
    label: "Raporlar",
